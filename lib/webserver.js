...
(function(exports) {
  ...
  var webserver = function(router,optimizer,meta_manager, grunt, web_paths){
    ...
    function max_latency_setter(req, res){
      ...
      max_congestion = parseInt( req.param("congestion") );
    ...
    function min_latency_setter(req, res){
      ...
      min_congestion = parseInt( req.param("congestion") );
    ...
    app.get("/stryke_min_congestion", min_latency_setter);
    ...
    function bdw_setter(req, res){
      ...
      cur_bdw = parseInt( req.param("bdw") );
      var headers = {
        'Content-Type': 'text/html'
      };
      res.writeHead(200, headers);
