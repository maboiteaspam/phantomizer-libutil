...
// catch for html route directory
            ...
            if( route != false ){
                grunt.log.ok("found routable url", request_path);
...
// regen the build
                        grunt.log.ok("is_built and is_not_fresh",request_path);
...
// make the build
                        grunt.log.ok("is_not_built and is_not_fresh",request_path);
...
// inject (prepend / append) assets (scripts / css) into the html tree
                        ...
                        if( user_config.scripts ){
                            grunt.log.ok("injecting scripts", request_path);
                        ...
                        if( user_config.css ){
                            grunt.log.ok("injecting css", request_path);
