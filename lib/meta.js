...
(function(exports) {
    ...
    return function(){
      ...
      this.load_dependencies = function(dependencies){
        for( var n in dependencies ){
          this.append_dependency(dependencies[n]);
        }
      };
      this.append_dependency = function(depdendency){
        if ( fs.existsSync(depdendency) ){
          var k = this.update_dependence_addressing(depdendency);
  ...
  var meta_manager = function(base_dir, meta_dir, default_deps){
    ...
    this.create = function(deps){
      ...
      entry.load_dependencies(default_deps);
      return entry
    }
